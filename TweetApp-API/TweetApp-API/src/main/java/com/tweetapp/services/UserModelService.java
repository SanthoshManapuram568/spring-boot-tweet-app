...
public class UserModelService {
	...
	public UserModel findByUsername(String username) {
		...
		UserModel newUserModel = new UserModel(userModel.getUsername(),userModel.getFirstName(),userModel.getLastName(),userModel.getEmail(),"null","null");
		return newUserModel;
	}
	...
	public List<UserModel> getAllUsers() {
		...
		List<UserModel> newUserModel = userModels.stream().map(user ->{
			return new UserModel(user.getUsername(),user.getFirstName(), user.getLastName(),user.getEmail(),"null","null" );
	...
	public UserModel changePassword(String username, String newPassword , String contact) throws Exception {
		...
		if(userDetails.getContactNum().equalsIgnoreCase(contact)&&userDetails.getUsername().equalsIgnoreCase(username)) {
