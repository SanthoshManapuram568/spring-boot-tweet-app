...
public class TweetController {
	...
	public ResponseEntity<?> getUserTweets(@PathVariable("username") String username,@RequestHeader (value = "loggedInUser") String loggedInUser ) {
		try {
	...
	public ResponseEntity<?> getTweetDeatils(@PathVariable("username") String username, @PathVariable("tweetId") String tweetId){
		try {
	...
	public ResponseEntity<?> updateTweet(@PathVariable("username") String userId, @RequestBody TweetUpdate tweetUpdate) {
//		log.info(tweetId);
//		log.info(tweetText);
...
//		System.out.println("===========>"+tweetText);
		try {
			...
			return new ResponseEntity<>(new ErrorResponse("Given tweetId cannot be found"),
	...
	public ResponseEntity<?> likeATweet(@PathVariable("username") String username,@PathVariable(value = "tweetId") String tweetId){
		try {
	...
	public ResponseEntity<?> dislikeATweet(@PathVariable("username") String username,@PathVariable(value = "tweetId") String tweetId){
		try {
